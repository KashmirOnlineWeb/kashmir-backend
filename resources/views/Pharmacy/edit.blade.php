        ...
        <div class="flex items-center justify-between mb-4">
            <div>
                <h1 class="text-lg font-semibold md:text-xl leading-none tracking-tight">
                    {{ isset($pharmacy) ? 'Edit Pharmacy' : 'Create Pharmacy' }}
                </h1>
            </div>
        </div>
        <?php 
            ...
            <div class="flex flex-wrap -mx-2 mb-4 border-b border-gray-200">
                <div class="w-full md:w-1/2 px-2 mb-4">
                    <div class="p-4">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Provide the basic details of the pharmacy.</p>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status"
                                class="mt-1 block w-full rounded-md border-gray-200 shadow-sm py-1">
                                <option value="0"
                                    {{ old('status', $pharmacy->status ?? 0) == 0 ? 'selected' : '' }}>
                                    Inactive</option>
                                <option value="1"
                                    {{ old('status', $pharmacy->status ?? 0) == 1 ? 'selected' : '' }}>
                                    Active
                                </option>
                            </select>
                            @error('status')
                    ...
                    <div class="p-4 border-b border-gray-200 rounded-md">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="image_alt" id="image_alt"
                                value="{{ old('image_alt', $pharmacy->image_alt ?? '') }}"
                                class="mt-1 block w-full rounded-md border-gray-200 shadow-sm py-1">
                        </div>
                    </div>
                </div>
...
@enderror
            ...
            <div class="mb-4">
                <button type="submit"
                    class="bg-black text-white p-2 rounded">{{ isset($pharmacy) ? 'Update Pharmacy' : 'Save Pharmacy' }}</button>
            </div>
        </form>
    </div>
</x-app-layout>
