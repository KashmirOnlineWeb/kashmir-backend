    ...
    public function store(Request $request): RedirectResponse
    {
        try {
            ...
            $response = Hotel::create([
                                        ...
                                        'star'              => $data['star'],
                                        'tax'               => $data['tax'],
                                        'total_lobbys'      => (isset($data['total_lobbys']) ? $data['total_lobbys'] : 0),
                                        'total_rooms'       => (isset($data['total_rooms']) ? $data['total_rooms'] : 0),
                                        'total_washrooms'   => (isset($data['total_washrooms']) ? $data['total_washrooms'] : 0),
                                        'highlights_content'=> (isset($data['highlights_content']) ? $data['highlights_content'] : NULL),
                                        //'status'            => $data['status'],
                                        //'meta_id'           => $meta->id,
